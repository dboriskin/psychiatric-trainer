...
export const MainLayout: React.FC<MainLayoutProps> = ({ 
  ...
  /**
   * Для мобильной версии: показываем кнопку карты навигации
   * Для десктопной версии: не показываем кнопку карты навигации, т.к. есть сайдбар
   */
  const shouldShowNavMapButton = showNavMap && isMobile;
